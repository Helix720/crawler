...
# This option cover urllib but i don't know if it cover 'requests'   #
# so be carreful. (Je vais tester sous peu)                          #
######################################################################
import random
import requests
from urllib2 import *
...
\033[1mOptions:\033[0m
    ...
    [--tor] -- Requests under tor network.
\033[1mUsage:\033[0m
...
def main():
	...
	parser.add_option("--tor", action="store_true")
